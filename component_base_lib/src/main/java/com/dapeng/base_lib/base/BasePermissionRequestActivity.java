 ...
 * 安卓6.0以上权限申请
 */
public abstract class BasePermissionRequestActivity extends AppCompatActivity {
     ...
     */
    public void requestNeedPermissions(@NonNull String permissionDes, PermissionCallback runnable, @NonNull String... permissions) {
            ...
            new AlertDialog.Builder(this)
                    ...
                    .setPositiveButton("授权", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ActivityCompat.requestPermissions(BasePermissionRequestActivity.this, permissions, requestCode);
                        }
